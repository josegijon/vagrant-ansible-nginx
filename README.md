...
4. [Certificado proporcionado por Let's Encrypt](#certificado-proporcionado-por-let's-encrypt)
...
5. [Autenticación básica](#autenticación-básica)
6. [Página de Error Personalizada](#página-de-error-personalizada)
